...
async function seedHomePageContent() {
  // Bootstrap Strapi without starting the server
  ...
  try {
    ...
    console.log('📝 Creating/updating home page content in Strapi...');
    
    // Check if home page exists
    const existingContent = await strapi.documents('api::home-page.home-page').findFirst({
      locale: 'en'
    });
    ...
    if (existingContent) {
      // Update existing
      console.log('Updating existing home page content...');
    ...
    if (result && result.documentId) {
      ...
      console.log('✅ Home page content published successfully!');
    }
