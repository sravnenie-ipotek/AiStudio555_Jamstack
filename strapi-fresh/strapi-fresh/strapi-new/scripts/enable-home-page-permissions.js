...
async function enableHomePagePermissions() {
  ...
  try {
    ...
    // Define the permissions we want to enable for home-page
    const apiPermissions = [
      { action: 'api::home-page.home-page.find' },
      { action: 'api::home-page.home-page.update' },
    ];
