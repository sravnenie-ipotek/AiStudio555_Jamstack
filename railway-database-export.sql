...
-- Data for courses (4 rows)
INSERT INTO courses VALUES (1, 'en', 'Web Development Bootcamp', 'Full-stack development with modern technologies', 499, '16 Weeks', '45 Lessons', 'Web Dev', 4.7, 1, '2025-09-11T10:32:05.875Z', '2025-09-11 10:32:05', '2025-09-11 10:32:05');
INSERT INTO courses VALUES (2, 'en', 'Data Science Fundamentals', 'Complete guide to data analysis and visualization', 399, '12 Weeks', '28 Lessons', 'Data Science', 4.9, 1, '2025-09-11T10:32:05.876Z', '2025-09-11 10:32:05', '2025-09-11 10:32:05');
INSERT INTO courses VALUES (3, 'en', 'Advanced Python Programming', 'Master Python for data science and web development', 249, '10 Weeks', '32 Lessons', 'Programming', 4.8, 1, '2025-09-11T10:32:05.876Z', '2025-09-11 10:32:05', '2025-09-11 10:32:05');
INSERT INTO courses VALUES (4, 'en', 'Introduction to Machine Learning', 'Learn the fundamentals of ML algorithms and applications', 299, '8 Weeks', '24 Lessons', 'AI & ML', 4.9, 1, '2025-09-11T10:32:05.876Z', '2025-09-11 10:32:05', '2025-09-11 10:32:05');
...
CREATE TABLE pricing_plans (id SERIAL PRIMARY KEY, name TEXT NOT NULL, price DECIMAL(10,2), currency TEXT DEFAULT 'USD', features TEXT, recommended BOOLEAN DEFAULT 0, locale TEXT DEFAULT 'en', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);

-- Data for pricing_plans (3 rows)
INSERT INTO pricing_plans VALUES (1, 'Basic', 99.99, 'USD', 'Access to fundamental courses, Community support', 0, 'en', '2025-09-11 15:17:01', '2025-09-11 15:17:01');
INSERT INTO pricing_plans VALUES (2, 'Professional', 199.99, 'USD', 'All courses, 1-on-1 mentoring, Career support', 1, 'en', '2025-09-11 15:17:01', '2025-09-11 15:17:01');
INSERT INTO pricing_plans VALUES (3, 'Enterprise', 499.99, 'USD', 'Everything + Custom training, Priority support', 0, 'en', '2025-09-11 15:17:01', '2025-09-11 15:17:01');
...
-- Data for footer_content (3 rows)
...
-- Data for footer_navigation_menus (4 rows)
INSERT INTO footer_navigation_menus VALUES (1, 'en', 'main', 'Main', 1, 1, '[{"text":"Home","url":"/home.html","target":"_self","order":1,"visible":true},
...
INSERT INTO footer_navigation_menus VALUES (2, 'en', 'company', 'Company', 2, 1, '[{"text":"About Us","url":"/about-us.html","target":"_self","order":1,"visible":true},
...
INSERT INTO footer_navigation_menus VALUES (3, 'en', 'legal', 'Legal', 3, 1, '[{"text":"Privacy Policy","url":"/privacy-policy","target":"_self","order":1,"visible":true},
...
INSERT INTO footer_navigation_menus VALUES (7, 'he', 'main', 'תפריט', 1, 1, '[
...
-- Data for footer_social_links (8 rows)
...
-- Data for footer_newsletter_config (3 rows)
...
-- Data for home_pages (1 rows)
INSERT INTO home_pages VALUES (1, 'he', 'AI Studio - Hebrew', 'קורסים מוצעים', 'משך הקורסים', 'תעודות והסמכה', 'תמיכה בקריירה', 'דרישות קדם', 'למידה בקצב אישי', '2025-09-14 09:46:05', '2025-09-14 09:46:05', '2025-09-14 09:46:05');


-- Commit transaction
COMMIT;

-- Export completed at 2025-09-23 15:17:06.572562
