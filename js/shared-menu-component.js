...
(function() {
            ...
            <div class="container">
                <div class="navbar-content">
                    <a href="${urls.home}" class="nav-brand">
                        <img loading="lazy" src="${currentLang === 'en' ? 'images/Logo.svg' : '../images/Logo.svg'}" alt="" class="logo-image">
                    </a>
    ...
    function updateExistingNavigation() {
        ...
        careerOrientationLinks.forEach(link => {
            ...
            if (link.textContent.trim() !== t.careerOrientation) {
        ...
        careerCenterLinks.forEach(link => {
            ...
            if (link.textContent.trim() !== t.careerCenter) {
