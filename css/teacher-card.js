...
class SharedTeacherCard {
    constructor() {
        ...
        console.log('🎯 [SharedTeacherCard] Initializing with dual-system architecture...');
    ...
    async init() {
        ...
        if (this.initialized) {
            console.log('ℹ️ [SharedTeacherCard] Already initialized, skipping');
            return;
        }

        try {
            console.log('🚀 [SharedTeacherCard] Starting initialization...');
    ...
    renderTeachers() {
        ...
        if (this.rendering) {
            console.log('⚠️ [SharedTeacherCard] Already rendering, skipping to prevent loop');
            return;
        }
            ...
            <div class="shared-teacher-card" data-teacher-id="${teacher.id}">
                ...
                <div class="teacher-photo-wrapper">
                    <img src="${photo}"
                         ...
                         class="teacher-photo"
                         loading="lazy"
                         onerror="this.src='images/placeholder-teacher.jpg'">
    ...
    getTeacherPhoto(teacher) {
        return teacher.profile_image_url ||
               'images/placeholder-teacher.jpg';
    }
...
if (!window.sharedTeacherCard) {
    ...
    console.log('✅ [SharedTeacherCard] Component loaded and ready');
} else {
    console.log('ℹ️ [SharedTeacherCard] Component already exists, skipping initialization');
}