  ...
  attributes: {
    ...
    duration: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    durationUnit: Schema.Attribute.Enumeration<['days', 'weeks', 'months']> &
      Schema.Attribute.DefaultTo<'weeks'>;
    enrollments: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    instructor: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    learningOutcomes: Schema.Attribute.Component<
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'AI Studio - Learn Programming with AI'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
